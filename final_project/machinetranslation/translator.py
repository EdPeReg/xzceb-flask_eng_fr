"""
Using watsoon api to translate some text from french-english and english-french
"""
# import json
import os
...
def french_to_english(french_text: str):
    ...
    """
    french_text = language_translator.translate(text=french_text,model_id='fr-en').get_result()
    return french_text['translations'][0]['translation']
